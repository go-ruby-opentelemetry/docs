...
The public API lives at the module root (`github.com/go-ruby-opentelemetry/opentelemetry`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `opentelemetry`, while the surface follows
...
```go
import "github.com/go-ruby-opentelemetry/opentelemetry"
```
...
- **[pkg.go.dev/github.com/go-ruby-opentelemetry/opentelemetry](https://pkg.go.dev/github.com/go-ruby-opentelemetry/opentelemetry)**

The module's [README](https://github.com/go-ruby-opentelemetry/opentelemetry#readme) carries worked
