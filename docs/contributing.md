...
Contributions are welcome. `go-ruby-opentelemetry/opentelemetry` is built to a small set of
...
The library is in [`github.com/go-ruby-opentelemetry/opentelemetry`](https://github.com/go-ruby-opentelemetry/opentelemetry).
This documentation site is in [`github.com/go-ruby-opentelemetry/docs`](https://github.com/go-ruby-opentelemetry/docs).
