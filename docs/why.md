...
`go-ruby-opentelemetry/opentelemetry` reimplements Ruby's `opentelemetry` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-opentelemetry/opentelemetry` directly, with no Ruby runtime;
